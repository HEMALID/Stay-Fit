...
object Constants {
    ...
    fun defaultExerciseList():ArrayList<ExerciseModel>{
        ...
        val jumpingJack = ExerciseModel(
            1,"Jumping jack",R.drawable.ic_jumping_jacks, isCompleted=false,false
        )
        exerciseList.add(jumpingJack)

        val wallSit = ExerciseModel(2, "Wall Sit", R.drawable.ic_wall_sit, isCompleted=false, false)
        exerciseList.add(wallSit)

        val pushUp = ExerciseModel(3, "Push Up", R.drawable.ic_push_up, isCompleted=false, false)
